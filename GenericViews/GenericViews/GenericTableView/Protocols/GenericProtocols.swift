...
import UIKit
// Delegates
protocol LoadMoreFromBottomDelegate: AnyObject {
...
protocol GenericTableViewInterface: GenericFilterableInterface {
...
protocol GenericModelType: Identifiable, AnyObject {
...
protocol SelectableTableViewRows: AnyObject {
...
protocol GenericFilterableInterface {
...
protocol GenericCell: UITableViewCell {
